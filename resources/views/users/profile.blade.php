          ...
          <div class="card-body box-profile">
            <div class="text-center">
              <img class="profile-user-img img-fluid img-circle"
                   src="{{ $user["avatar"] or '/img/avatar.png' }}"
                   alt="User profile picture">
            </div>

            <h3 class="profile-username text-center">{{ $user["username"] or '' }}</h3>
            ...
            <div class="card-body"> 
                ...
                <p class="text-muted">{{ $user["description"] or ""}}</p>
              </div>
            </div>
          <!-- /.card-body -->
        </div>
              ...
              <div class="active tab-pane" id="settings">
                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{ route("update_profile") }}">
                  ...
                  <div class="form-group row">
                    ...
                    <img id="showImage" src="{{ $user["avatar"] or '/img/avatar.png' }}" alt="" height="60" width="60">
                    </div>
                  </div>
                  <div class="form-group row">
